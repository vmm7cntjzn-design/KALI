...
function FR(name,url,typ){ return {name,url,typ}; }
...
K('windrose','WINDROSE Finest Travel','Berlin','Ultra-Luxus / Individualreisen',
  [KT('Verena Hartmann','Reisedesignerin Afrika & Arabien','','',['Kenia','Uganda','Ruanda','Tansania'])],
  {
    ...
    fokus:{
      Kenia:[
        FR('Kenia Rundreise – Flugsafari (11T)','https://windrose.de/de-de/kenia-rundreise','Privatreise'),
        FR('Kenia par Excellence – Individualreise (10T)','https://www.windrose.de/reiseziele/afrika/kenia/privatreise/kenia-par-excellence','Privatreise'),
        FR('Kenia Familienreise – Flugsafari & Strand (12T)','https://windrose.de/reiseziele/afrika/kenia/privatreise/kenia-fuer-grosse-und-kleine-abenteurer','Privatreise'),
        FR('Rhythmus der Wildnis – Flugsafari (11T)','https://windrose.de/de-de/rundreise-kenia-deluxe','Privatreise'),
        FR('Kenia & Ruanda Kombireise (12T)','https://windrose.de/de-de/kenia-ruanda-rundreise-deluxe','Privatreise'),
        FR('Kenia Jenseits von Afrika – Private Rundreise','https://windrose.de/reiseziele/afrika/kenia/privatreise/kenia-jenseits-von-afrika','Privatreise'),
        FR('Kenia – Wilde Schönheit (Gruppenreise)','https://www.windrose.de/reiseziele/afrika/kenia/gruppenreise','Gruppenreise'),
      ],
      Tansania:[
        FR('Tansania Rundreise – Serengeti & Ngorongoro (10T)','https://windrose.de/de-de/rundreise-tansania-deluxe','Privatreise'),
        FR('Tansania par Excellence – Safari & Sansibar (10T)','https://www.windrose.de/reiseziele/afrika/tansania/privatreise/tansania-par-excellence','Privatreise'),
        FR('Out of Africa – Serengeti Select (10T)','https://windrose.de/de-de/rundreise-tansania-select-2025','Privatreise'),
        FR('Das Beste von Tansania (7T)','https://www.windrose.de/reiseziele/afrika/tansania/privatreise/das-beste-von-tansania','Privatreise'),
        FR('Tansania – Königreich der Tiere (Gruppenreise, 10T)','https://www.windrose.de/reiseziele/afrika/tansania/gruppenreise/tansania-koenigreich-der-tiere','Gruppenreise'),
        FR('Tansania 2025 – Serengeti Rundreise Select','https://www.windrose.de/de-de/rundreise-tansania-select-2025','Privatreise'),
      ],
      Ruanda:[
        FR('Ruanda – Vulkane & Berggorillas','https://www.windrose.de/reiseziele/afrika/ruanda/privatreise/ruanda-vulkane-und-berggorillas','Privatreise'),
        FR('Ruanda kurz & intensiv – Gorillas & Safari','https://www.windrose.de/reiseziele/afrika/ruanda/privatreise/ruanda-kurz-und-intensiv','Privatreise'),
        FR('Ruanda Rundreise Select (12T)','https://windrose.de/de-de/ruanda-rundreise-select','Privatreise'),
      ],
      Uganda:[
        FR('Uganda – Die Perle Afrikas (11T, Gorilla & Schimpansen)','https://www.windrose.de/reiseziele/afrika/uganda/privatreise/uganda-die-perle-afrikas','Privatreise'),
      ],
    },
    luecken:[
...
K('lernidee','Lernidee Erlebnisreisen','Berlin','Gruppenreisen / Bahnreisen / Individual',
  ...
  ],
  {
    ...
    fokus:{
      Kenia:[FR('Kenia & Ostafrika Safari','https://www.lernidee.de/reisen/kat/Afrika','Gruppenreise')],
      Tansania:[FR('Tansania-Safari & Rovos Rail (Kapstadt–Daressalam)','https://www.lernidee.de/reisen/kat/Afrika','Bahnreise')],
      Ruanda:[FR('Ruanda Safari & Gorilla','https://www.lernidee.de/reisen/kat/Afrika','Gruppenreise')],
      Uganda:[FR('Uganda & Ruanda – Berggorillas (15T, max. 6 Gäste/Fahrzeug)','https://www.lernidee.de/reise.html?r=2550','Gruppenreise')],
    },
    luecken:[
...
K('iwanowski',"Iwanowski's Reisen (afrika.de)",'Neuss','Individualreisen / Spezialveranstalter',
  [KT('Michael Iwanowski','Geschäftsführer & Gründer','+49 2133 26030','info@afrika.de',['Kenia','Uganda','Ruanda','Tansania'])],
  {
    ...
    dest:{aktiv:['Kenia','Tansania','Uganda','Ruanda'],duenn:[],fehlt:[]},
    fokus:{
      Kenia:[FR('Individuelle Kenia & Tansania Safari (Bausteine)','https://www.afrika.de/kenia-tansania/','Individualreise')],
      Tansania:[FR('Tansania Individualsafaris (inkl. Flugsafari Süden)','https://www.afrika.de/tansania/','Individualreise')],
      Uganda:[FR('Uganda & Ruanda Individualreise','https://www.afrika.de/uganda-ruanda/safaris/','Individualreise')],
      Ruanda:[FR('Ruanda & Uganda Individualreise','https://www.afrika.de/uganda-ruanda/','Individualreise')],
    },
...
K('studiosus','Studiosus Reisen','München','Studienreisen / Gruppenreisen',
  [KT('Peter-Mario Kubsch','Geschäftsführer','+49 89 500 60','info@studiosus.com',['Kenia','Tansania'])],
  {
    ...
    fokus:{
      Kenia:[FR('Kenia und Tansania – Naturparks Ostafrikas (16T, ab 8.920€)','https://www.studiosus.com/reise/kenia-tansania/7301K-kenia-und-tansania-naturparks-ostafrikas-flug-mit-lufthansa-fluganreise','Studienreise')],
      Tansania:[
        FR('Tansania – auf Safari (10T)','https://www.studiosus.com/Tansania/Ngorongoro-Krater/smart-and-small/7344E--Tansania-auf-Safari--Eigenanreise','Studienreise'),
...
K('gebeco','Gebeco','Kiel','Gruppenreisen / Erlebnisreisen',
  [KT('Produktmanagement Afrika','Produktmanager Afrika','+49 431 545 45 0','info@gebeco.de',['Kenia','Uganda','Ruanda'])],
  {
    ...
    fokus:{
      Kenia:[FR('Kenia & Tansania – Savannenträume (13T)','https://www.gebeco.de/reisen/kenia-und-tansania/2430006/','Gruppenreise')],
      Uganda:[FR('Von Uganda nach Ruanda: Gorilla-Treks & Safaris','https://www.gebeco.de/reisen/von-uganda-nach-ruanda-gorilla-treks-safaris/4G9X108/','Gruppenreise')],
  ...
  [KT('Afrika-Reiseberatung','Reiseberater Afrika','+49 351 31207-0','info@diamir.de',['Kenia','Uganda','Ruanda','Tansania'])],
  {
    ...
    fokus:{
      Kenia:[
        ...
        FR('Kenia & Uganda – Gnu Wanderung & Gorillas (15T)','https://www.diamir.de/kenia+uganda/privatreise/KENUGA','Aktivreise'),
        FR('Kenia Safari und Baden (14T, ab 2.990€)','https://www.diamir.de/kenia/reise/kenlod','Naturreise'),
      ...
      Tansania:[
        ...
        FR('Kenia & Tansania Safari & Migration (8T)','https://www.diamir.de/kenia+tansania/privatreise/KENLUX','Naturreise'),
      ],
      Uganda:[
        FR('Uganda & Ruanda – Berggorillas & Schimpansen (14T, ab 4.390€)','https://www.diamir.de/uganda+ruanda/reise/UGARUA','Gruppenreise'),
  ...
  ],
  {
    ...
    fokus:{
      Kenia:[
        ...
        FR('Leopard for You – Kenia & Tansania Privatreise','https://www.chamaeleon-reisen.de/Afrika/Tansania-Kenia/Leopard4You','Privatreise'),
      ],
      Uganda:[
      ...
      Ruanda:[FR('Uganda & Ruanda – Gorilla Trekking Kombinationsreise','https://www.chamaeleon-reisen.de/Afrika/Uganda-Ruanda','Gruppenreise')],
    },
    luecken:[
...
K('travelnature','travel-to-nature','Freiburg','Naturreisen / Nachhaltig',
  [KT('Christian','Afrika & Operations Experte','+49 7634 50550','info@traveltonature.de',['Tansania','Uganda','Ruanda'])],
  {
    ...
    fokus:{
      Tansania:[FR('Tansania individuell (Gorilla + Safari)','https://www.travel-to-nature.de/afrika/uganda-ruanda/','Naturreise')],
      Uganda:[FR('Uganda Klassisch Naturnah / Intensiv','https://www.travel-to-nature.de/afrika/uganda-reisen/','Naturreise')],
...
K('tanzspecialist','Tanzania Specialist','Berlin / Tansania','Individual Safari',
  [KT('Julia','Reiseleitung / Buchungsleitung','Über Website','julia@tanzaniaspecialist.de',['Tansania'])],
  {
    ...
    dest:{aktiv:['Tansania'],duenn:[],fehlt:['Kenia','Uganda','Ruanda']},
    fokus:{
      Tansania:[FR('Tansania Safari & Sansibar (individuell)','https://tanzaniaspecialist.de/','Individualreise')],
      Kenia:[],Uganda:[],Ruanda:[],
    },
...
K('felixsafaris','Felix Safaris','Tsavo / Deutschland','Individual Safari',
  [KT('Felix','Inhaber & Reiseveranstalter','Über Website','felix@felix-safaris.com',['Kenia','Tansania'])],
  {
    ...
    dest:{aktiv:['Kenia','Tansania'],duenn:[],fehlt:['Uganda','Ruanda']},
    fokus:{
      Kenia:[FR('Kenia & Tansania Individuelle Safaris','https://www.felix-safaris.com/','Individualreise')],
...
K('ventertours','Venter Tours','Deutschland','Kleingruppen / Privatreisen',
  [KT('Produktteam','Reiseleiter Kenia/Tansania','Über Website','info@ventertours.de',['Kenia','Tansania'])],
  {
    ...
    dest:{aktiv:['Kenia','Tansania'],duenn:[],fehlt:['Uganda','Ruanda']},
    fokus:{
      Kenia:[FR('SIMBA – Safarierlebnis Kenia & Tansania (13T)','https://www.ventertours.de/reisen/simba-safarierlebnis-kenia-tansania/','Gruppenreise')],
...
K('cobraverde','Cobra Verde Afrikareisen','Deutschland','Luxus-Safaris',
  [KT('Luxus-Safari-Beratung','Produktmanager Luxus','Über Website','info@cobra-verde.de',['Kenia','Tansania','Uganda','Ruanda'])],
  {
    ...
    dest:{aktiv:['Kenia','Tansania','Uganda','Ruanda'],duenn:[],fehlt:[]},
    fokus:{
      Ruanda:[FR('Luxus-Gorilla-Expedition Ruanda (individuell, Volcanoes NP)','https://www.cobra-verde.de/','Luxusreise')],
      Kenia:[FR('Kenia Luxus-Safari (individuell)','https://www.cobra-verde.de/','Luxusreise')],
      Tansania:[FR('Tansania Luxus-Safari (individuell)','https://www.cobra-verde.de/','Luxusreise')],
      Uganda:[FR('Uganda Gorilla Luxury (individuell)','https://www.cobra-verde.de/','Luxusreise')],
    },
...
K('aufunddavon','Auf und Davon Reisen','Deutschland','Minigruppen / Abenteuer',
  [KT('Inhaber / Reiseleiter','Inhaber Uganda','Über Website','info@auf-und-davon-reisen.de',['Uganda','Ruanda'])],
  {
    ...
    fokus:{
      Uganda:[FR('Berggorillas & Schimpansen – 14T Uganda & Ruanda','https://auf-und-davon-reisen.de/uganda-ruanda-gorilla-safarireise-minigruppe/','Minigruppe')],
      Ruanda:[FR('Berggorillas & Schimpansen – 14T Uganda & Ruanda','https://auf-und-davon-reisen.de/uganda-ruanda-gorilla-safarireise-minigruppe/','Minigruppe')],
      Kenia:[],Tansania:[],
    },
...
K('wigwam','Wigwam Tours','Deutschland','Gruppenreisen / Tansania',
  [KT('Reiseleitung Tansania','Reiseleiter / Reiseberater','Über Website','info@wigwam-tours.de',['Tansania'])],
  {
    ...
    dest:{aktiv:['Tansania'],duenn:[],fehlt:['Kenia','Uganda','Ruanda']},
    fokus:{
      Tansania:[FR('Tansania Gruppen & Private Safaris (Serengeti, Great Migration)','https://wigwam-tours.de/tanzania.html','Gruppenreise')],
      Kenia:[],Uganda:[],Ruanda:[],
    },
...
var defaultOps = [
  {id:'manya',name:'Manya Africa Tours',land:'Uganda / Ruanda / Kenia / Tansania',url:'https://manyaafricatours.com',preisniveau:'Budget bis Luxury (USD 800–4.500 p.P./Tag)',
   ...
   touren:[
    ...
    {id:'m27',name:'14-Days Uganda Wildlife & Primate Safari',dest:'Uganda',tage:14,niveau:'midrange',
     url:'https://manyaafricatours.com/tour/14-days-uganda-wildlife-primate-safari/',
     img:'',
     desc:'A carefully designed 14-day journey through Uganda\'s most iconic landscapes: Murchison Falls, Queen Elizabeth NP, and Bwindi. Shoebill tracking, rhino tracking, chimpanzees in Budongo, tree-climbing lions in Ishasha, gorilla trekking in Bwindi, and a walking safari in Lake Mburo.',
     tags:['uganda','gorilla','chimps','wildlife','murchison','queen-elizabeth','bwindi','primaten','shoebill','walking-safari','comprehensive'],
     highlights:[
       'Shoebill tracking in Mabamba Swamp',
       'Rhino tracking on foot at Ziwa Rhino Sanctuary',
       'Top of the Falls visit at Murchison Falls',
       'Game drives & boat safari on the Victoria Nile',
       'Chimpanzee tracking in Budongo Forest',
       'Authentic farm experience at Rubalika Safari Lodge',
     ...
     itinerary:[
       'Day 1 – Arrival in Entebbe. Transfer to hotel. Accommodation: The Boma Hotel Entebbe / 2 Friends Beach Hotel. No meals.',
       'Day 2 – Mabamba Shoebill Tracking & Ziwa Rhino Sanctuary. Early morning canoe trip for shoebill tracking in Mabamba Swamp. Proceed to Ziwa Rhino Sanctuary for on-foot rhino tracking. Accommodation: Amuka Safari Lodge. Full Board.',
       'Day 3 – Transfer to Murchison Falls National Park. Visit the Top of the Falls where the Nile squeezes through a narrow gorge. Accommodation (2 nights): Murchison River Lodge / Pakuba Safari Lodge. Full Board.',
       'Day 4 – Game Drive & Boat Safari. Morning game drive: elephants, lions, giraffes, buffaloes. Afternoon boat cruise to the bottom of the falls along the Victoria Nile. Accommodation: As above. Full Board.',
       'Day 5 – Chimpanzee Tracking in Budongo & Transfer to Lake Albert. Morning chimpanzee tracking in Budongo Forest. Transfer to lodge overlooking Lake Albert. Accommodation: Kikonko Lodge. Full Board.',
       'Day 6 – Transfer to Rubalika Safari Lodge and Farm. Drive to western Uganda. Authentic countryside experience. Accommodation: Rubalika Safari Lodge and Farm. Full Board.',
       'Day 7 – Farm Experience & Transfer to Queen Elizabeth NP. Morning farm visit. Transfer to Queen Elizabeth National Park. Accommodation: Marafiki Safari Lodge. Full Board.',
       'Day 8 – Optional Kyambura Chimpanzee Tracking / Game Drive & Kazinga Boat Safari. Optional morning chimp tracking in Kyambura Gorge or game drive. Afternoon boat safari on Kazinga Channel. Accommodation: Marafiki Safari Lodge. Full Board.',
       'Day 9 – Transfer to Bwindi via Ishasha Sector. Visit salt lakes, drive through Ishasha sector (tree-climbing lions). Continue to Bwindi Impenetrable NP, Buhoma sector. Accommodation: Haven Lodge Buhoma. Full Board.',
       'Day 10 – Gorilla Trekking & Optional Batwa Tradition. Morning gorilla trekking in Bwindi. Optional Batwa Tradition or community village walk. Accommodation: Haven Lodge Buhoma. Full Board.',
       'Day 11 – Transfer to Lake Mburo National Park. Drive to Lake Mburo. Evening scenic sundowner experience. Accommodation: Rwakobo Safari Lodge / Mpogo Safari Lodge. Full Board.',
       'Day 12 – Walking Safari & Leisure. Morning guided walking safari in Lake Mburo NP. Rest of day at leisure. Accommodation: Rwakobo / Mpogo Safari Lodge. Full Board.',
       'Day 13 – Transfer to Entebbe. Drive to Entebbe with equator stop for photos. Accommodation: The Boma Hotel Entebbe / 2 Friends Beach Hotel. B&B.',
       'Day 14 – Departure. Breakfast, transfer to Entebbe International Airport.',
     ],
     hotels:['The Boma Hotel Entebbe / 2 Friends Beach Hotel','Amuka Safari Lodge','Murchison River Lodge / Pakuba Safari Lodge','Murchison River Lodge / Pakuba Safari Lodge','Kikonko Lodge','Rubalika Safari Lodge and Farm','Marafiki Safari Lodge','Marafiki Safari Lodge','Haven Lodge Buhoma','Haven Lodge Buhoma','Rwakobo / Mpogo Safari Lodge','Rwakobo / Mpogo Safari Lodge','The Boma Hotel Entebbe / 2 Friends Beach Hotel',''],
     prices:['1 Person: $7,465','2 Persons sharing: $4,873','4 Persons sharing: $3,904','6 Persons sharing: $3,567','Single supplement: $714'],
     included:[
       'Accommodation as outlined in itinerary',
       'Meals as indicated (Full Board throughout)',
       'Park entries',
       '4x4 safari vehicle with English-speaking guide',
     ...
     not_included:[
       ...
       'Travel insurance',
       'Gorilla trekking permit ($800 p.P.)',
       'Chimpanzee permit Budongo ($130 p.P.)',
       'Optional chimp permit Kyambura ($100 p.P.)',
       'Tips and personal expenses',
     ],
     gallery:[],scraped_at:'2026-05-26'},
    {id:'m27',name:'14-Days Uganda Wildlife & Primate Safari',dest:'Uganda',tage:14,niveau:'midrange',
     url:'https://manyaafricatours.com/tour/14-days-uganda-wildlife-primate-safari/',
     img:'',desc:'14-day journey through Uganda: Murchison Falls, Queen Elizabeth NP, and Bwindi. Shoebill tracking, rhino tracking, chimpanzees in Budongo Forest, tree-climbing lions in Ishasha, gorilla trekking in Bwindi, and walking safari in Lake Mburo.',
     tags:['uganda','gorilla','chimps','wildlife','murchison','queen-elizabeth','bwindi','primaten','shoebill','walking-safari','comprehensive'],
     highlights:['Shoebill tracking in Mabamba Swamp','Rhino tracking on foot at Ziwa Rhino Sanctuary','Murchison Falls Top of Falls & boat safari','Chimpanzee tracking in Budongo Forest','Authentic farm experience at Rubalika Safari Lodge','Kazinga Channel boat cruise','Tree-climbing lions in Ishasha sector','Gorilla trekking in Bwindi Impenetrable NP','Walking safari in Lake Mburo NP'],
     itinerary:['Day 1 – Arrival in Entebbe. Overnight: The Boma Hotel Entebbe / 2 Friends Beach Hotel.','Day 2 – Shoebill tracking Mabamba Swamp & Ziwa Rhino Sanctuary on foot. Overnight: Amuka Safari Lodge.','Day 3 – Transfer to Murchison Falls NP. Top of the Falls visit. Overnight: Murchison River Lodge / Pakuba Safari Lodge.','Day 4 – Morning game drive & afternoon boat cruise on Victoria Nile to bottom of falls. Overnight: Murchison River Lodge.','Day 5 – Chimpanzee tracking in Budongo Forest. Transfer to Lake Albert. Overnight: Kikonko Lodge.','Day 6 – Transfer to Rubalika Safari Lodge and Farm for authentic countryside experience. Overnight: Rubalika Safari Lodge.','Day 7 – Morning farm visit. Transfer to Queen Elizabeth NP. Overnight: Marafiki Safari Lodge.','Day 8 – Optional chimp tracking Kyambura Gorge or game drive. Afternoon Kazinga Channel boat safari. Overnight: Marafiki Safari Lodge.','Day 9 – Salt lakes visit. Drive through Ishasha sector (tree-climbing lions). Continue to Bwindi. Overnight: Haven Lodge Buhoma.','Day 10 – Gorilla trekking in Bwindi Impenetrable NP. Optional Batwa Tradition or village walk. Overnight: Haven Lodge Buhoma.','Day 11 – Transfer to Lake Mburo NP. Evening sundowner. Overnight: Rwakobo / Mpogo Safari Lodge.','Day 12 – Morning walking safari Lake Mburo. Leisure afternoon. Overnight: Rwakobo / Mpogo Safari Lodge.','Day 13 – Transfer to Entebbe via equator stop. Overnight: The Boma Hotel Entebbe.','Day 14 – Departure from Entebbe International Airport.'],
     hotels:['The Boma Hotel Entebbe','Amuka Safari Lodge','Murchison River Lodge / Pakuba Safari Lodge','Murchison River Lodge','Kikonko Lodge','Rubalika Safari Lodge','Marafiki Safari Lodge','Marafiki Safari Lodge','Haven Lodge Buhoma','Haven Lodge Buhoma','Rwakobo / Mpogo Safari Lodge','Rwakobo / Mpogo Safari Lodge','The Boma Hotel Entebbe',''],
     prices:['1 Person: $7,465','2 Persons sharing: $4,873','4 Persons sharing: $3,904','6 Persons sharing: $3,567','Single supplement: $714'],
     included:['Accommodation as per itinerary','Full Board meals throughout','Park entries','4x4 safari vehicle with English-speaking guide','All airport transfers','Tourist activities as per itinerary','Bottled water in vehicle','Government taxes'],
     not_included:[],gallery:[],scraped_at:'2026-05-26'},
    {id:'m28',name:'11-Day Highlights of Uganda Safari',dest:'Uganda',tage:11,niveau:'midrange',
     url:'https://manyaafricatours.com/tour/11-day-highlights-of-uganda-safari/',
     img:'',desc:'11-day Uganda highlights: Murchison Falls, chimpanzee tracking in Kibale Forest, Queen Elizabeth NP with Kazinga Channel boat safari, gorilla trekking in Bwindi, and Lake Bunyonyi. Available in mid-range and luxury versions.',
     tags:['uganda','gorilla','chimps','wildlife','murchison','queen-elizabeth','bwindi','kibale','primaten','lake-bunyonyi','comprehensive'],
     highlights:['Murchison Falls boat trip & game drives','Optional Ziwa Rhino Sanctuary','Chimpanzee tracking in Kibale Forest','Optional Bigodi Wetlands walk','Kazinga Channel water safari','Gorilla trekking in Bwindi','Optional Batwa cultural visit','Lake Bunyonyi by canoe or on foot'],
     itinerary:['Day 1 – Depart to Murchison Falls NP. Optional Ziwa Rhino stop. Overnight: Paraa Safari Lodge.','Day 2 – Boat trip to bottom of Murchison Falls. Morning game drive. Overnight: Paraa Safari Lodge.','Day 3 – Drive to Kibale Forest. Overnight: Turacco Tree Tops (midrange) / Kyaninga Lodge (luxury).','Day 4 – Chimpanzee tracking in Kibale Forest. Optional Bigodi Wetlands walk. Overnight: Crater Safari Lodge (midrange) / Kyaninga Lodge (luxury).','Day 5 – Drive through the Rift Valley to Queen Elizabeth NP. Overnight: Parkview Lodge (midrange) / Katara Lodge (luxury).','Day 6 – Morning game drive. Afternoon Kazinga Channel water safari. Overnight: Parkview Lodge (midrange) / Mweya Safari Lodge (luxury).','Day 7 – Transfer to Bwindi Impenetrable NP. Overnight: Haven Lodge (midrange) / Mahogany Springs / Silverback Lodge (luxury).','Day 8 – Gorilla trekking in Bwindi. Optional Batwa cultural visit. Overnight: Haven Lodge (midrange) / Silverback Lodge (luxury).','Day 9 – Drive to Lake Bunyonyi. Canoe or nature walk. Overnight: Birds Nest Lodge.','Day 10 – Depart for Entebbe.','Day 11 – Transfer to departure flight.'],
     hotels:['Paraa Safari Lodge','Paraa Safari Lodge','Turacco Tree Tops / Kyaninga Lodge','Crater Safari Lodge / Kyaninga Lodge','Parkview Lodge / Katara Lodge','Parkview Lodge / Mweya Safari Lodge','Haven Lodge / Silverback Lodge','Haven Lodge / Silverback Lodge','Birds Nest Lodge','',''],
     prices:[],
     included:['Accommodation as per itinerary','Full Board meals','Park entries','4x4 safari vehicle with guide','All transfers','Bottled water'],
     not_included:[],gallery:[],scraped_at:'2026-05-26'},
    {id:'m29',name:'14-Day Uganda & Rwanda Combined Luxury Safari',dest:'Uganda',tage:14,niveau:'luxury',
     url:'https://manyaafricatours.com/tour/14-day-uganda-rwanda-combined-luxury-safari/',
     img:'',desc:'14-day luxury safari combining Uganda and Rwanda: Murchison Falls, Kibale chimps, Queen Elizabeth NP, gorilla trekking in both Bwindi (Uganda) and Volcanoes NP (Rwanda), Lake Bunyonyi, and Lake Mburo walking safari.',
     tags:['uganda','ruanda','gorilla','chimps','luxury','wildlife','murchison','queen-elizabeth','bwindi','volcanoes','kibale','primaten','comprehensive','premium'],
     highlights:['Gorilla trekking in Bwindi & Parc National des Volcans Rwanda','Chimpanzee tracking in Kibale Forest','Murchison Falls boat cruise & game drives','Kazinga Channel boat safari','Tree-climbing lions Queen Elizabeth NP','Lake Bunyonyi canoe & nature walks','Lake Mburo walking safari','Cultural encounters in local villages'],
     itinerary:['Day 1 – Arrival in Entebbe. Overnight: The Boma Hotel.','Day 2 – Drive to Murchison Falls NP. Overnight: Paraa Safari Lodge.','Day 3 – Boat safari on the Nile to bottom of Murchison Falls. Morning game drive. Overnight: Paraa Safari Lodge.','Day 4 – Drive to Kibale Forest NP. Overnight: Primate Lodge Kibale.','Day 5 – Chimpanzee tracking in Kibale Forest. Overnight: Primate Lodge Kibale.','Day 6 – Drive through Rift Valley to Queen Elizabeth NP. Overnight: Mweya / Katara Lodge.','Day 7 – Morning game drive. Afternoon Kazinga Channel boat safari. Overnight: Mweya / Katara Lodge.','Day 8 – Optional chimp tracking Kyambura Gorge. Overnight: Mweya / Katara Lodge.','Day 9 – Drive to Bwindi via Ishasha (tree-climbing lions). Overnight: Gorilla Nest Lodge.','Day 10 – Gorilla trekking in Parc National des Volcans, Rwanda. Overnight: Gorilla Nest Lodge.','Day 11 – Drive to Lake Bunyonyi. Canoe & nature walk. Overnight: Birds Nest Lodge.','Day 12 – Depart to Lake Mburo NP. Overnight: Rwakobo / Mpogo Safari Lodge.','Day 13 – Walking safari Lake Mburo. Leisure. Overnight: Rwakobo / Mpogo Safari Lodge.','Day 14 – Transfer to Entebbe. Departure.'],
     hotels:['The Boma Hotel','Paraa Safari Lodge','Paraa Safari Lodge','Primate Lodge Kibale','Primate Lodge Kibale','Mweya / Katara Lodge','Mweya / Katara Lodge','Mweya / Katara Lodge','Gorilla Nest Lodge','Gorilla Nest Lodge','Birds Nest Lodge','Rwakobo / Mpogo Safari Lodge','Rwakobo / Mpogo Safari Lodge',''],
     prices:['2 Persons sharing: $6,800','4 Persons sharing: $5,700','6 Persons sharing: $5,500','Single supplement: $1,010'],
     included:['Accommodation as per itinerary (luxury lodges)','Full Board meals throughout','Park entries','4x4 safari vehicle with English-speaking guide','All airport transfers','Bottled water in vehicle','Government taxes'],
     not_included:[],gallery:[],scraped_at:'2026-05-26'},
    ...
    {id:'m24',name:'4-Day Kenya Beach Resort Package',dest:'Kenia',tage:4,niveau:'midrange',url:'https://manyaafricatours.com/tour/kenya-beach-packages/',img:'',desc:'Experience the enchanting allure of Kenya's Indian Ocean coastline with this exquisite Mombasa beach holiday at Diani Beach. Swahili culture, coral reefs, and pristine white beaches.',tags:['kenia','strand','mombasa','diani','beach','entspannung','kombi'],highlights:[],itinerary:[],hotels:[],prices:[],included:[],not_included:[],gallery:[],scraped_at:''},
    {id:'m25',name:'11-Days From Bush to Beach Kenya Safari',dest:'Kenia',tage:11,niveau:'midrange',url:'https://manyaafricatours.com/tour/11-day-kenya-budget-safari/',img:'',desc:'The perfect combination of Kenya's iconic safari highlights and a relaxing beach stay on the Indian Ocean at Mombasa. From Masai Mara to Diani Beach.',tags:['kenia','strand','mombasa','masai-mara','amboseli','kombi','safari'],highlights:[],itinerary:[],hotels:[],prices:[],included:[],not_included:[],gallery:[],scraped_at:''},
